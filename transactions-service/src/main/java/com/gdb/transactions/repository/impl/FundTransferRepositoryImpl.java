...
public class FundTransferRepositoryImpl implements FundTransferRepository {
    ...
    private FundTransfer insert(FundTransfer fundTransfer) {
        String sql = """
            ...
            VALUES (:fromAccount, :toAccount, :amount, :mode)
            """;
        ...
        MapSqlParameterSource params = new MapSqlParameterSource()
            ...
            .addValue("mode", fundTransfer.getTransferMode().name());

        KeyHolder keyHolder = new GeneratedKeyHolder();
        jdbcTemplate.update(sql, params, keyHolder, new String[]{"id"});

        Number key = keyHolder.getKey();
        if (key == null) throw new RuntimeException("Failed to retrieve generated key after insert");
    ...
    private FundTransfer update(FundTransfer fundTransfer) {
        String sql = """
            ...
            SET from_account = :fromAccount, to_account = :toAccount, transfer_amount = :amount, transfer_mode = :mode
            WHERE id = :id
            """;
